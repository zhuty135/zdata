...
if [ $d_type == 'fut' ]; then
    ...
    /usr/local/anaconda3/bin/zipline ingest -b dtaa > /tmp/b_dtaa.log 2>&1 
    #/work/jzhu/project/ql/script/taa.py -m ql/taa/lo -s 20190512 -g 2 -t glob > /tmp/dtaa.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -l taa -t glob -m ql/taa/lo -b dtaa -g 2 -s 20190512 > /tmp/dtaa.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/taa/lo.glob.20 > /tmp/dtaa.pc.log 2>&1 


    scp -rp /work/shared/daily/ql/fox/*glob.60.*2024* user1@8.142.157.170:/work/shared/daily/slib/mmw/
    scp -rp /work/shared/daily/ql/taa/*glob*2024* jzhu@123.57.60.6:/work/dwhang/project/sit/Shiny/yzpa/
    #/work/jzhu/project/slib/script/bby.py -t lo.glob.20 -w ewb2  -m ql/taa -s 20160512 > /tmp/zmpa_zbw_glob_ewb2.log 2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l bby -m slib/jw/lo -t  -f w -s 20210505 -b cit > /tmp/zmpa_zbw_glob_ewb2.log 2>&1 


elif [ $d_type == 'fox' ]; then
    /usr/local/anaconda3/bin/zipline ingest -b fox > /tmp/b_fox.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -l fox -t glob -m ql/fox/lo -b fox -g 3 -s 20150512 -e 20230801 > /tmp/fox.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/fox/lo.glob.30 > /tmp/fox.pc.log 2>&1 

    /work/jzhu/project/ql/script/runql.sh -l fox -t glob -m ql/fox/lo -b fox -g 4 -s 20150512  > /tmp/fox4.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/fox/lo.glob.40 > /tmp/fox4.pc.log 2>&1 

    /work/jzhu/project/ql/script/runql.sh -l fox -t glob -m ql/fox/lo -b fox -g 5 -s 20150512  > /tmp/fox5.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/fox/lo.glob.50 > /tmp/fox5.pc.log 2>&1 

    /work/jzhu/project/ql/script/runql.sh -l fox -t glob -m ql/fox/lo -b fox -g 6 -s 20150512  > /tmp/fox5.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/fox/lo.glob.60 > /tmp/fox6.pc.log 2>&1 

    /work/jzhu/project/ql/script/rungolmar.sh > /tmp/golmar.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/fox/rungolmar > /tmp/olmar.pc.log 2>&1 
    ...
    #/work/jzhu/project/zdata/csvpolish.py39 -i Index --index_col='time' > /tmp/cipol.log 2>&1
    #/usr/local/anaconda3/bin/zipline ingest -b cit > /tmp/b_cit.log 2>&1 
    ...
    scp -rp user1@8.142.157.170:/work/ruizhi/val/*2023*csv /work/jzhu/input/yf/risk/
    /work/jzhu/project/zlib/zrisk.py -m cal_cb18 -o > /tmp/cal_risk.log 2>&1
    ...
    scp -rp user1@8.142.157.170:/work/shared/moredata/*csv /work/jzhu/input/yf/moredata/
    ...
    scp -rp user1@8.142.157.170:/work/shared/doc/*csv /work/jzhu/input/yf/doc/
    scp -rp /work/jzhu/input/yf/*  123.57.60.6:/work/jzhu/input/yf/
    cp /work/jzhu/input/yf/idxetf/*.csv /work/jzhu/input/mix/
    cp /work/jzhu/input/yf/global/*.csv /work/jzhu/input/mix/
    /work/jzhu/project/zdata/csvpolish.py39 -i /work/jzhu/input/mix/ > /tmp/mix.pol.log 2>&1

    #scp -rp /work/jzhu/input/iv/*.csv 123.57.60.6:/work/jzhu/input/iv/ > /tmp/iv.log 2>&1
    /work/jzhu/project/zdata/csvpolish.py39 -i /work/jzhu/input/iv/ > /tmp/iv.pol.log 2>&1
    ...
    /usr/local/anaconda3/bin/zipline ingest -b md > /tmp/bun_md.log 
    ...
    /work/jzhu/project/zdata/csvpolish.py39 -i /work/jzhu/input/idxetf/ -c NYSE > /tmp/idxetf.pol.log 
    /work/jzhu/project/zdata/csvpolish.py39 -i /work/jzhu/input/global/ -c NYSE > /tmp/global.pol.log 

    /usr/local/anaconda3/bin/zipline ingest -b idxetf > /tmp/bun_idxetf.log 
    /work/jzhu/project/zlib/zstats_p39.py -m cal_kdj -o -t idxetf > /tmp/chaodi.log
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t ixlo  -f w -s 20190505 -b idxetf -c NYSE > /work/shared/daily/log/chaodi_idxetf.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t ixl2 -f w -s 20190505 -b idxetf -c NYSE > /work/shared/daily/log/chaodi_ixl2.log  2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.ixlo > /work/shared/daily/log/chaodi_ixlo.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.ixl2 > /work/shared/daily/log/chaodi_idl2.clog  2>&1 &

    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t ixso  -f w -s 20190505 -b idxetf -c NYSE -x S > /work/shared/daily/log/chaodi_ixlo.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t ixs2 -f w -s 20190505 -b idxetf -c NYSE  -x S > /work/shared/daily/log/chaodi_ixl2.log  2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.ixso > /work/shared/daily/log/chaodi_ixso.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.ixs2 > /work/shared/daily/log/chaodi_ixs2.clog  2>&1 &

    /usr/local/anaconda3/bin/zipline ingest -b global > /tmp/bun_global.log 
    /work/jzhu/project/zlib/zstats_p39.py -m cal_kdj -o -t spgs > /tmp/chaodi.log
    #/work/jzhu/project/slib/script/kdj.py -t splo -s 20150505 > /work/shared/daily/log/chaodi_splo.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t splo -f w -s 20150505 -b global -c NYSE > /work/shared/daily/log/chaodi_splo.log  2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.splo > /work/shared/daily/log/chaodi_splo.clog  2>&1 &

    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t spso -f w -s 20150505 -b global -c NYSE -x S > /work/shared/daily/log/chaodi_spso.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t sps2 -f w -s 20150505 -b global -c NYSE -x S > /work/shared/daily/log/chaodi_sps2.log  2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.spso > /work/shared/daily/log/chaodi_spso.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.sps2 > /work/shared/daily/log/chaodi_sps2.clog  2>&1 &

    /work/jzhu/project/ql/script/runql.sh -t qdix -s 20190512 -b idxetf  -c NYSE  > /work/shared/daily/log/zmpa.qdix.log 2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.qdix > /work/shared/daily/log/zmpa.qdix.clog 2>&1 &
    ...
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t iv6m -f w -s 20220905 -b ivm > /work/shared/daily/log/chaodi_iv6m.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t iv1m -f w -s 20220905 -b ivm > /work/shared/daily/log/chaodi_iv1m.log  2>&1
    ...
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t hzlo -f w -s 20180505 -b md  >/work/shared/daily/log/cd_hzlo.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t hzl2 -f w -s 20120505 -b md  >/work/shared/daily/log/cd_hzl2.log  2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.hzlo > /work/shared/daily/log/chaodi_hzlo.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.hzl2 > /work/shared/daily/log/chaodi_hzl2.clog  2>&1 &

    /work/jzhu/project/ql/script/runql.sh -t hzpa -s 20160512 -b md > /work/shared/daily/log/zmpa.hzpa.log 2>&1
    /work/jzhu/project/ql/script/runql.sh -t hzh1 -s 20160512 -b md > /work/shared/daily/log/zmpa.hzh1.log 2>&1
    /work/jzhu/project/ql/script/runql.sh -t hzh2 -s 20160512 -b md > /work/shared/daily/log/zmpa.hzh2.log 2>&1
    scp -rp /work/shared/daily/ql/zmpa/ZMPA.wsign.hzpa*2023* user1@8.142.157.170:/work/shared/daily/slib/mmw/ 
    scp -rp /work/shared/daily/ql/zmpa/ZMPA.wsign.hzh1*2023* user1@8.142.157.170:/work/kuang/daily/slib/mmw/ 
    scp -rp /work/shared/daily/ql/zmpa/ZMPA.wsign.hzh2*2023* user1@8.142.157.170:/work/yfeng/daily/slib/mmw/ 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.hzpa > /work/shared/daily/log/zmpa.hzpa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.hzh1 > /work/shared/daily/log/zmpa.hzh1.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.hzh2 > /work/shared/daily/log/zmpa.hzh2.clog 2>&1 &

    /usr/local/anaconda3/bin/zipline ingest -b nh > /tmp/bun_nh.log 
    /work/jzhu/project/ql/script/runql.sh -t nhpa  -s 20200512 -b nh > /work/shared/daily/log/zmpa.nhpa.log 2>&1
    scp -rp /work/shared/daily/ql/zmpa/ZMPA.wsign.nhpa*2023* user1@8.142.157.170:/work/kuang/daily/slib/mmw/ 
    /work/jzhu/project/ql/script/runql.sh -t nhsa  -s 20160512 -b nh > /work/shared/daily/log/zmpa.nhsa.log 2>&1
    /work/jzhu/project/ql/script/runql.sh -t nhca  -s 20160512 -b nh > /work/shared/daily/log/zmpa.nhca.log 2>&1

    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.nhca > /work/shared/daily/log/zmpa.nhca.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.nhsa > /work/shared/daily/log/zmpa.nhsa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.nhpa > /work/shared/daily/log/zmpa.nhpa.clog 2>&1 &

    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t nfno -f w -s 20161205 -b nh  >/work/shared/daily/log/cd_nfno.log  2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t nslo -f w -s 20200505 -b nh  >/work/shared/daily/log/cd_nslo.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t nflo -f w -s 20210505 -b nh  >/work/shared/daily/log/cd_nflo.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t nolo -f w -s 20210505 -b nh  >/work/shared/daily/log/cd_nolo.log  2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.nslo > /work/shared/daily/log/chaodi_nslo.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.nflo > /work/shared/daily/log/chaodi_nflo.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.nolo > /work/shared/daily/log/chaodi_nolo.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.nfno > /work/shared/daily/log/chaodi_nfno.clog  2>&1 &

    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t nsso -f w -s 20210505 -b nh -x S > /work/shared/daily/log/chaodi_nsso.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t nfso -f w -s 20210505 -b nh -x S > /work/shared/daily/log/chaodi_nfso.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t noso -f w -s 20210505 -b nh -x S > /work/shared/daily/log/chaodi_noso.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t nos2 -f w -s 20210505 -b nh -x S > /work/shared/daily/log/chaodi_nos2.log  2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.nsso > /work/shared/daily/log/chaodi_nsso.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.nfso > /work/shared/daily/log/chaodi_nfso.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.noso > /work/shared/daily/log/chaodi_noso.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.nos2 > /work/shared/daily/log/chaodi_nos2.clog  2>&1 &

    /work/jzhu/project/ql/script/runql.sh -t fipa -s 20160512 -b md > /work/shared/daily/log/zmpa.fipa.log 2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.fipa > /work/shared/daily/log/zmpa.fipa.clog 2>&1 &
    #scp -rp /work/shared/daily/ql/zmpa/ZMPA.wsign.fipa*2023* user1@8.142.157.170:/work/shared/daily/slib/mmw/ 
    scp -rp /work/shared/daily/ql/zmpa/ZMPA.wsign.fipa*2023* user1@8.142.157.170:/work/shared/daily/slib/mmw/ 
    scp -rp /work/shared/daily/ql/zmpa/ZMPA.wsign.fipa*2023* user1@8.142.157.170:/work/kuang/daily/slib/mmw/ 



elif [ $d_type == 'nh' ]; then
    #20230325 scp -rp 123.57.60.6:/work/jzhu/input/nh/*.csv /work/jzhu/input/nh/ > /tmp/nh.log 2>&1
    ...
    /work/jzhu/project/zlib/zstats_p39.py -m cal_kdj -o -t nh > /tmp/chaodi_nh.log
    ...
    /work/jzhu/project/ql/script/runql.sh -t gloetf -s 20190512 -b idxetf  -c NYSE  > /work/shared/daily/log/zmpa.qdix.log 2>&1
    #/work/jzhu/project/ql/script/zmpa.py -t secetf -s 20190512 > /work/shared/daily/log/zmpa.secetf.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -t secetf -s 20190512 -b idxetf  -c NYSE  > /work/shared/daily/log/zmpa.secetf.log 2>&1
    #/work/jzhu/project/ql/script/zmpa.py -t cashetf -s 20190512 > /work/shared/daily/log/zmpa.cashetf.log 2>&1  
    /work/jzhu/project/ql/script/runql.sh -t cashetf -s 20190512 -b idxetf  -c NYSE  > /work/shared/daily/log/zmpa.cashetf.log 2>&1

    #/work/jzhu/project/ql/script/zmpa.py -t idxetf -s 20150512 -m ql/zmpa/ZMPA -r w -l lo > /work/shared/daily/log/zmpa.idx.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -t idxetf -s 20190512 -b idxetf  -c NYSE  > /work/shared/daily/log/zmpa.idx.log 2>&1
    ...
    /work/jzhu/project/finger/misc/simpleplot.py   -t fox > /tmp/fox.log 2>&1 &
    ...
    /work/jzhu/project/zlib/zsprd.py -m cal_crv -t nhpa.sect.cov  -o  > /tmp/calcrv_nh.sect.cov  2>&1
    ...
    /work/jzhu/project/zlib/zsprd.py -m cal_crv -t nhpa.sect.corr -o   > /tmp/calcrv_nh.sect.corr 2>&1
    /work/jzhu/project/zlib/zsprd.py -m cal_crv -t spgs.sect.corr  -o  > /tmp/calcrv_spgs.sect.corr 2>&1

    /work/jzhu/project/zlib/zsprd.py -m cal_hr  -t risk -o  > /tmp/cal_hr_risk.log 2>&1



    /work/jzhu/project/zlib/zsprd.py -m cal_csab -t hz_csab  -o  > /tmp/caliv_hz.csab.log 2>&1

    /work/jzhu/project/zlib/zsprd.py -m cal_csab -t tf_csab  -o  > /tmp/caliv_tf.csab.log 2>&1
    /work/jzhu/project/ql/script/runql.sh -t tfsprd -s 20160512 -b  sprd > /work/shared/daily/log/zmpa.tfsprd.log 2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.tfsprd > /work/shared/daily/log/zmpa.tfsprd.clog 2>&1 &
    ...
    /work/jzhu/project/finger/misc/qb_plt.py -t hz -o -f                    > /tmp/dmv_hz.log 2>&1  
    /work/jzhu/project/finger/misc/qb_plt.py -t nh -o -f                    > /tmp/dmv_nh.log 2>&1  
    /work/jzhu/project/finger/misc/qb_plt.py -t hz -o -f -m iv -s 20210108  > /tmp/iv_hz.log 2>&1  
    ...
    scp -rp /work/shared/output/dmv_*.pdf jzhu@123.57.60.6:/work/dwhang/project/sit/Shiny/yzpa/tmp/  > /tmp/scp_iv.log 2>&1 &
    ...
    /work/jzhu/project/finger/misc/pm_strat.R > /tmp/pmstrat.log.$edate 2>&1 
    /work/jzhu/project/finger/misc/pm_zstrat.R > /tmp/pmzstrat.log.$edate 2>&1 
    /work/jzhu/project/finger/misc/pm_stratfi.R > /tmp/pmstratfi.log.$edate 2>&1 
    ...
    scp -rp /work/shared/output/a_pm_strafi*   user1@8.142.157.170:/work/shared/daily/stra/ > /tmp/scp_pm_yf.log 2>&1 &
    scp -rp /work/shared/output/a_pm_pxhz*   user1@8.142.157.170:/work/shared/daily/stra/ > /tmp/scp_pm_hz.log 2>&1 &


    /work/jzhu/project/finger/misc/sa.pm  > /tmp/sa.log.$edate 2>&1
    scp -rp /work/shared/output/b_sa*.pdf jzhu@123.57.60.6:/work/dwhang/project/sit/Shiny/yzpa/
    ...
    scp -rp /work/shared/output/a_* jzhu@123.57.60.6:/work/dwhang/project/sit/Shiny/yzpa/ 
    ...
    scp -r /work/shared/output/complot* jzhu@123.57.60.6:/work/dwhang/project/sit/Shiny/yzpa/
    scp -r /work/shared/output/iv_*.pdf jzhu@123.57.60.6:/work/dwhang/project/sit/Shiny/yzpa/tmp/
    scp -r /work/shared/output/a_* jzhu@123.57.60.6:/work/dwhang/project/sit/Shiny/yzpa/
    scp -r /work/shared/output/dmv_idxetf.pdf jzhu@123.57.60.6:/work/dwhang/project/sit/Shiny/yzpa/
    ...
    /work/jzhu/project/ql/script/runql.sh -l calm -t cfpa -m ql/calm/CALM -s 20160512 > /work/shared/daily/log/zmpa.ifpa.log 2>&1
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/calm/CALM.cfpa > /work/shared/daily/log/calm.clog 2>&1
    #scp -rp /work/shared/daily/ql/calm/CALM.wsign.cfpa.2023* jzhu@106.14.226.83:/work/shared/daily/ql/calm/ > /tmp/calm_scp.log
    ...
    /usr/local/anaconda3/bin/zipline ingest -b dtaa > /tmp/b_dtaa.log 2>&1 
    #/work/jzhu/project/ql/script/runql.sh -t hzpa -s 20160512 -b dtaa > /work/shared/daily/log/zmpa.hzpa.log 2>&1
    #/work/jzhu/project/ql/script/runql.sh -t hzsa -s 20160512 -b md > /work/shared/daily/log/zmpa.hzsa.log 2>&1
    /work/jzhu/project/ql/script/runql.sh -t qdii -s 20190512 -b md > /work/shared/daily/log/zmpa.qdii.log 2>&1
    ...
    /work/jzhu/project/ql/script/runql.sh -t cfp1  -s 20160512 > /work/shared/daily/log/zmpa.cfp1.log 2>&1
    /work/jzhu/project/ql/script/runql.sh -t cfp2  -s 20160512 > /work/shared/daily/log/zmpa.cfp2.log 2>&1
    ...
    /work/jzhu/project/ql/script/runql.sh -t cfz2 -m ql/zmpa/LOZMPA -b cit -f w -s 20161212 > /work/shared/daily/log/lozmpa.cfz2.log 2>&1
    /work/jzhu/project/ql/script/runql.sh -t hack -m ql/zmpa/LOZMPA -b nh -f w -s 20210130 > /work/shared/daily/log/lozmpa.hack.log 2>&1
    /work/jzhu/project/ql/script/runql.sh -t hzpa -m ql/zmpa/LOZMPA -b md -f w > /work/shared/daily/log/lozmpa.hzpa.log 2>&1

    scp -rp /work/shared/daily/ql/zmpa/ZMPA.wsign.cfpa*2023* user1@8.142.157.170:/work/shared/daily/slib/mmw/ 
    scp -rp /work/shared/daily/ql/zmpa/*2023* jzhu@123.57.60.6:/work/dwhang/project/sit/Shiny/yzpa/

    
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.cfpa > /work/shared/daily/log/zmpa.cfpa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.cfp1 > /work/shared/daily/log/zmpa.cfp1.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.cfp2 > /work/shared/daily/log/zmpa.cfp2.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.cfsa > /work/shared/daily/log/zmpa.cfsa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.cfca > /work/shared/daily/log/zmpa.cfca.clog 2>&1 &
    #/work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.hzpa > /work/shared/daily/log/zmpa.hzpa.clog 2>&1 &
    #/work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.hzsa > /work/shared/daily/log/zmpa.hzsa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.qdii > /work/shared/daily/log/zmpa.qdii.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.ifpa > /work/shared/daily/log/zmpa.ifpa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.tfpa > /work/shared/daily/log/zmpa.tfpa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/ZMPA.fipa > /work/shared/daily/log/zmpa.fipa.clog 2>&1 &
    #/work/jzhu/project/slib/script/pickle_to_csv.p39y -m  ql/zmpa/LOZMPA.cfo2 > /work/shared/daily/log/zmpa.cfo2.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/LOZMPA.cfz2 > /work/shared/daily/log/zmpa.cfz2.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/zmpa/LOZMPA.hzpa > /work/shared/daily/log/zmpa.hzpa.clog 2>&1 &

    scp -rp /work/jzhu/output/ql/zmpa/ZMPA.*.csv jzhu@123.57.60.6:/work/jzhu/input/se2018/daily/
    scp -rp /work/jzhu/output/ql/zmpa/ZMPA.cf*a.csv jzhu@123.57.60.6:/work/dwhang/project/sit/Shiny/yzpa/risk/



elif [ $d_type == 'dmw' ]; then
    /usr/local/anaconda3/bin/zipline ingest -b dmw > /tmp/b_dmw.log 2>&1
    ...
    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20220502 -t copc -o diff -p False > /work/shared/daily/log/mw.co.diff.log 2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20230102 -t cofu -o net  -p False > /work/shared/daily/log/mw.cofu.net.log 2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20220502 -t copm -o net  -p False > /work/shared/daily/log/mw.copm.net.log 2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20220502 -t hzpc -o diff -p False > /work/shared/daily/log/mw.hz.diff.log 2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20220502 -t hzfu -o net  -p False > /work/shared/daily/log/mw.hzfu.net.log 2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20220502 -t tfpc -o net  -p False > /work/shared/daily/log/mw.tfpc.net.log 2>&1 

    scp -rp /work/shared/daily/slib/mmw/*2023* jzhu@106.14.226.83:/work/shared/daily/slib/mmw/ 2>&1  
    scp -rp /work/shared/daily/slib/mmw/*cofu*2023* user1@8.142.157.170:/work/shared/daily/slib/mmw/ 2>&1  
    scp -rp /work/shared/daily/slib/mmw/*cofu*2023* user1@8.142.157.170:/work/kuang/daily/slib/mmw/ 2>&1  
    scp -rp /work/jzhu/output/slib/mmw/ls.cofu.ew.csv user1@8.142.157.170:/work/shared/daily/slib/mmw/ 2>&1  

    #/work/jzhu/project/slib/script/mw.py -s 20210630 -t cofu -o all -f > /work/shared/daily/log/mw.cofu.all.log 2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20210630 -t cofu -o all -p True -w ew > /work/shared/daily/log/mw.cofu.all.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/mmw/ls.cofu.ew   > /work/shared/daily/log/lw.cffu.clog 2>&1 &

    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20210630 -t copm -o all -p True -w ew > /work/shared/daily/log/mw.copm.all.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/mmw/ls.copm.ew   > /work/shared/daily/log/lw.cfpm.clog 2>&1 &

    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20180630 -t cols -o all -p True -w ew > /work/shared/daily/log/mw.cols.all.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/mmw/ls.cols.ew   > /work/shared/daily/log/lw.cols.clog 2>&1 &

    #/work/jzhu/project/slib/script/mw.py -s 20210630 -t tffu -o all -f > /work/shared/daily/log/mw.tffu.all.log 2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20210630 -t tffu -o all -p True -w ew > /work/shared/daily/log/mw.tffu.all.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/mmw/ls.tffu.ew   > /work/shared/daily/log/lw.tffu.clog 2>&1 &

    /work/jzhu/project/slib/script/runslib.sh -l mw -m slib/mmw/ls -f w -b dmw -s 20210630 -t tfpc -o all -p True -w ew > /work/shared/daily/log/mw.tfpc.all.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/mmw/ls.tfpc.ew   > /work/shared/daily/log/lw.tfpc.clog 2>&1 &
    ...
    /work/jzhu/project/ql/script/runql.sh -l lw -m ql/ssl/ls -t cflw -f w -s 20160512 > /work/shared/daily/log/lw.ls.cflw.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/ssl/ls.cflw  > /work/shared/daily/log/lw.cflw.clog 2>&1 &
    ...
    /work/jzhu/project/ql/script/runql.sh -l lw -m ql/ssl/ls -t hzlw -f w -b md -s 20160512 > /work/shared/daily/log/lw.ls.hzlw.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/ssl/ls.hzlw  > /work/shared/daily/log/lo.hzlw.clog 2>&1 &

    /work/jzhu/project/ql/script/runql.sh -l lw -m ql/ssl/lo -t qdlw -f w -b md -s 20190512 > /work/shared/daily/log/lw.lo.qdlw.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/ssl/lo.qdlw  > /work/shared/daily/log/lo.qdlw.clog 2>&1 &

    /usr/local/anaconda3/bin/zipline ingest -b dtaa > /tmp/b_dtaa.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -l lw -m ql/ssl/ls -t dtlw -f w -b dtaa -s 20190512 > /work/shared/daily/log/lw.ls.dtlw.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/ssl/ls.dtlw  > /work/shared/daily/log/ls.dtlw.clog 2>&1 &
    ...
    /work/jzhu/project/ql/script/runql.sh -l lw -m ql/ssl/ls -t tflw -f w -s 20160512 > /work/shared/daily/log/lw.ls.cflw.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/ssl/ls.tflw  > /work/shared/daily/log/ls.tflw.clog 2>&1 &
    ...
    /usr/local/anaconda3/bin/zipline ingest -b dtaa > /tmp/b_dtaa.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -l dma -m ql/dma/DMA -t mtaa -f w -s 20150512 -b dtaa > /work/shared/daily/log/dma.dtaa.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -l dma -m ql/dma/DMA -t cfpa -f w -s 20150512 > /work/shared/daily/log/dma.cfpa.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -l dma -m ql/dma/DMA -t tfpa -f w -s 20150512 > /work/shared/daily/log/dma.tfpa.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -l dma -m ql/dma/DMA -t cfca -f w -s 20150512 > /work/shared/daily/log/dma.cfca.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -l dma -m ql/dma/DMA -t cfsa -f w -s 20150512 > /work/shared/daily/log/dma.cfsa.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -l dma -m ql/dma/DMA -t hzpa -f w -b md -s 20150512 > /work/shared/daily/log/dma.hzpa.log 2>&1 
    /work/jzhu/project/ql/script/runql.sh -l dma -m ql/dma/DMA -t hzsa -f w -b md -s 20150512 > /work/shared/daily/log/dma.hzsa.log 2>&1 

    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/dma/DMA.ls.cfpa > /work/shared/daily/log/dma.cfpa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/dma/DMA.ls.tfpa > /work/shared/daily/log/dma.tfpa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/dma/DMA.ls.cfca > /work/shared/daily/log/dma.cfca.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/dma/DMA.ls.cfsa > /work/shared/daily/log/dma.cfsa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/dma/DMA.ls.hzpa > /work/shared/daily/log/dma.hzpa.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  ql/dma/DMA.ls.hzsa > /work/shared/daily/log/dma.hzsa.clog 2>&1 &
    ...
    /work/jzhu/project/zlib/zstats_p39.py -m cal_bb -o -t cfpa -l 10  > /tmp/cal_bb_cfpa10.log 2>&1
    /work/jzhu/project/zlib/zstats_p39.py -m cal_bb -o -t cfpa -l 20  > /tmp/cal_bb_cfpa20.log 2>&1
    /work/jzhu/project/zlib/zstats_p39.py -m cal_bb -o -t cfpa -l 40  > /tmp/cal_bb_cfpa40.log 2>&0
    /work/jzhu/project/zlib/zstats_p39.py -m cal_bb -o -t shsz -l 10  > /tmp/cal_bb_cfpa10.log 2>&0
    /work/jzhu/project/zlib/zstats_p39.py -m cal_bb -o -t shsz -l 20  > /tmp/cal_bb_cfpa20.log 2>&0
    /work/jzhu/project/zlib/zstats_p39.py -m cal_bb -o -t shsz -l 40  > /tmp/cal_bb_cfpa40.log 2>&0
    ...
    /work/jzhu/project/slib/script/runslib.sh -l rw -m slib/lws/lo -t cfrw -f w -s 20180512 > /work/shared/daily/log/rw.lo.cfrw.log 2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l rw -m slib/lws/so -t cfrw -f w -s 20180512 > /work/shared/daily/log/rw.so.cfrw.log 2>&1 
    /work/jzhu/project/slib/script/pickle_to_csv.py39  -m  slib/lws/lo.cfrw  > /work/shared/daily/log/rw.lo.cfrw.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39  -m  slib/lws/so.cfrw  > /work/shared/daily/log/rw.so.cfrw.clog 2>&1 &
    ...
    /work/jzhu/project/slib/script/runslib.sh -l rw -m slib/lws/lo -t hzrw -f w -b md -s 20060512 > /work/shared/daily/log/rw.lo.hzrw.log 2>&1 
    /work/jzhu/project/slib/script/runslib.sh -l rw -m slib/lws/lo -t tfrw -f w -s 20160512 > /work/shared/daily/log/rw.so.tfrw.log 2>&1 



    /work/jzhu/project/slib/script/pickle_to_csv.py39  -m  slib/lws/lo.hzrw  > /work/shared/daily/log/rw.lo.hzrw.clog 2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39  -m  slib/lws/lo.tfrw  > /work/shared/daily/log/rw.lo.tfrw.clog 2>&1 &
    ...
    scp -rp   user1@8.142.157.170:/work/shared/tradedata/SH/*24* /work/jzhu/input/tradedata/SH/
    scp -rp   user1@8.142.157.170:/work/shared/tradedata/SZ/*24* /work/jzhu/input/tradedata/SZ/
    scp -rp  user1@8.142.157.170:/work/shared/tradedata/CFE/*24* /work/jzhu/input/tradedata/CFE/
    scp -rp  user1@8.142.157.170:/work/shared/tradedata/CZC/*24* /work/jzhu/input/tradedata/CZC/
    scp -rp  user1@8.142.157.170:/work/shared/tradedata/DCE/*24* /work/jzhu/input/tradedata/DCE/
    scp -rp  user1@8.142.157.170:/work/shared/tradedata/INE/*24* /work/jzhu/input/tradedata/INE/
    scp -rp  user1@8.142.157.170:/work/shared/tradedata/SHF/*24* /work/jzhu/input/tradedata/SHF/
    ...
    #20230325 scp -rp 123.57.60.6:/work/jzhu/input/iv/*.csv /work/jzhu/input/iv/ > /tmp/iv.log 2>&1
    ...
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t cfco -f w -s 20210505 -b cit > /work/shared/daily/log/cd_cfco.log  2>&1
    ...
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t cfl2 -f w -s 20210505 -b cit > /work/shared/daily/log/cd_cfl2.log  2>&1
    ...
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t col2 -f w -s 20180505 -b cit > /work/shared/daily/log/cd_col2.log  2>&1
    ...
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t auag -f w -s 20180505 -b cit > /work/shared/daily/log/cd_pmlo.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t augc -f w -s 20180505 -b cit > /work/shared/daily/log/cd_pmlo.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t agsi -f w -s 20180505 -b cit > /work/shared/daily/log/cd_pmlo.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/jw/lo -t augc -f w -s 20180505 -b cit > /work/shared/daily/log/cd_pmlo.log  2>&1
    ...
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t hzso -f w -s 20180505 -b md -x S > /work/shared/daily/log/cd_hzso.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t hzs2 -f w -s 20180505 -b md -x S > /work/shared/daily/log/cd_hzs2.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t coso -f w -s 20180505 -b cit -x S > /work/shared/daily/log/cd_coso.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t cos2 -f w -s 20180505 -b cit -x S > /work/shared/daily/log/cd_cos2.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t cfs1 -f w -s 20180505 -b cit -x S > /work/shared/daily/log/cd_cfs1.log  2>&1
    /work/jzhu/project/slib/script/runslib.sh -l kdj -m slib/sw/so -t cfs2 -f w -s 20210505 -b cit -x S > /work/shared/daily/log/cd_cfs2.log  2>&1



    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.cfco > /work/shared/daily/log/chaodi_cfco.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.cflo > /work/shared/daily/log/chaodi_cflo.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.cfl2 > /work/shared/daily/log/chaodi_cfl2.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.colo > /work/shared/daily/log/chaodi_colo.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.col2 > /work/shared/daily/log/chaodi_col2.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.pmlo > /work/shared/daily/log/chaodi_colo.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.coso > /work/shared/daily/log/chaodi_cos.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.cos2 > /work/shared/daily/log/chaodi_cos2.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.cfs1 > /work/shared/daily/log/chaodi_cfs1.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.cfs2 > /work/shared/daily/log/chaodi_cfs2.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.hzso > /work/shared/daily/log/chaodi_hzso.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/sw/so.hzs2 > /work/shared/daily/log/chaodi_hzso.clog  2>&1 &
    /work/jzhu/project/slib/script/pickle_to_csv.py39 -m  slib/jw/lo.tflo > /work/shared/daily/log/chaodi_tflo.clog  2>&1 &
    ...
    /work/jzhu/project/ql/script/runql.sh -t ifpa -m ql/zmpa/single -b cit -f w -s 20151212  > /work/shared/daily/log/zmpa_ifpa_zgrid.log 2>&1
...
elif [ $d_type == 'cnmacro' ]; then
    #scp -rp 123.57.60.6:/work/yfchen/macro/*csv /work/jzhu/data/raw
    scp -rp   user1@8.142.157.170:/work/shared/macrofactor/*csv /work/jzhu/data/raw
    #20230325 scp -rp 123.57.60.6:/work/jzhu/input/idxetf/*csv /work/jzhu/input/idxetf/ 
    ...
    cp macro$l_last_date.csv macroraw.csv
    cp SHIBOR$l_last_date.csv SHIBOR3M.csv

    /work/jzhu/project/zlib/zstats_p39.py -m cal_macro -o > /tmp/cal_macro.log
    ...
    /work/jzhu/project/zdata/getfred.py > /tmp/fred.log 2>&1 
    scp -rp 123.57.60.6:/work/yfchen/US_macro/*csv /work/jzhu/data/raw
    #/work/jzhu/project/zdata/csvpolish.py39 -i /work/jzhu/input/idxetf > /tmp/idp.log 2>&1
    #/work/jzhu/project/zdata/csvpolish.py39 -i /work/jzhu/input/global > /tmp/idp.log 2>&1


    cp /work/jzhu/data/raw/pmi$l_last_date.csv /work/jzhu/data/raw/pmi.csv

    /work/jzhu/project/zlib/zsprd.py -m cal_usmacro -o > /tmp/cal_macro.log 2>&1 
    #cp /work/jzhu/output/macro/us_*.csv /work/jzhu/project/ql/data/

    /usr/local/anaconda3/bin/zipline ingest -b usm > /tmp/b_usm.log 2>&1

    #/work/jzhu/project/ql/script/spymacro.py -r w -t qqq.o -c us_DGS2 > /tmp/macro_qqq.log 
    /work/jzhu/project/ql/script/runql.sh -l spymacro -t qqq.o -m ql/mac/usm -f w -a us_DGS2 -c NYSE -b usm -s 20151212 > /tmp/r_spym.log 2>&1 
    ...
    scp -rp /work/jzhu/input/yf/moredata/000300.SH.csv jzhu@123.57.60.6:/work/jzhu/input/se2018/daily/
    scp -rp /work/jzhu/input/yf/moredata/399006.SZ.csv jzhu@123.57.60.6:/work/jzhu/input/se2018/daily/
    scp -rp /work/jzhu/input/yf/moredata/000016.SH.csv jzhu@123.57.60.6:/work/jzhu/input/se2018/daily/
